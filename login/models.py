...
class Pessoa(AbstractBaseUser, PermissionsMixin):
    ...
    PES_FOTO_URL = models.CharField(max_length=1000, blank=True, null=True)
    PES_FOTO_REFERENCIA = models.CharField(max_length=500)
    PES_TOKEN = models.CharField(max_length=200)
    PES_CADASTRO_COMPLETO = models.CharField(max_length=1)
